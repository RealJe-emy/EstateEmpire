        ...
        <section>
          ...
          <div className='flex flex-col md:flex-row items-center justify-center'>
            ...
            <p className='text-center md:text-left md:w-2/3'>
              Adwensha is a comprehensive real estate management application designed to streamline and enhance the property management experience. Whether you are a property owner, manager, or tenant, Adwensha offers a user-friendly interface to handle all your real estate needs efficiently. With features that include property listing, tenant management, lease tracking, maintenance requests, and financial reporting, the application ensures that every aspect of property management is covered. Adwensha's robust search functionality allows users to find properties for rent or purchase using text and image descriptions, making it easier to connect with potential buyers or renters. Its intuitive design and powerful tools help simplify complex tasks, saving time and improving productivity for all users involved in the real estate market.
            </p>
          </div>
        </section>
        ...
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            <a href="https://flowbite.com/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-black">Adwensha</span>
            </a>
          ...
          <span className="block text-sm text-black sm:text-center dark:text-gray-400">
            <a href="https://flowbite.com/" className="text-black hover:underline">Adwensha™</a>. All Rights Reserved.
          </span>
        </div>
      </footer>
    </div>
